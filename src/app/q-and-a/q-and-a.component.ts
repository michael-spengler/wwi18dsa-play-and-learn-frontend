...
export class QAndAComponent implements OnInit {
  ...
  ngOnInit() {
      ...
      console.log("on init von tic tac toe wird aufgerufen");
      ...
      document.addEventListener("DOMContentLoaded", function () {
        ...
        function TicTacToe (element) {
          var current = 0,
            ...
            messages = {
              ...
              "o-wins": "Spieler O gewinnt! Klick auf Rewards",
              "x-wins": "Spieler X gewinnt! Klick auf Rewards",
        ...
        //let games = new Array(document.querySelectorAll(".tic-tac-toe"));
        let games = this.querySelectorAll(".tic-tac-toe");
  
        for (let game of games) {
          TicTacToe(game); // aktuelles Fundstück steht in games[i]
        }
      });
